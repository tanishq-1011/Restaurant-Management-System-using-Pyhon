...
def Ref():
    ...
    CoCheese_Burger=float(Chicken_burger.get())

    CostofFries =CoF*0.99
    CostofDrinks =CoD*1.00
    CostofFilet =CoFilet*2.99
    CostofBurger =CoBurger*2.97
    CostofChicken_Burger =CoChicken*2.89
    CostofCheese_Burger =CoCheese_Burger*2.79

    CostofMeal= "$",str('%.2f' % (CostofFries+CostofDrinks
                                  +CostofFilet +  CostofBurger+ CostofChicken_Burger +CostofCheese_Burger))

    PayTax =(CostofFries+CostofDrinks
                                  +CostofFilet +  CostofBurger+ CostofChicken_Burger +CostofCheese_Burger)*0.2

    TotalCost= (CostofFries+CostofDrinks
                                  +CostofFilet +  CostofBurger+ CostofChicken_Burger +CostofCheese_Burger)
    Ser_Charge= (CostofFries+CostofDrinks
                                  +CostofFilet +  CostofBurger+ CostofChicken_Burger +CostofCheese_Burger)/99
